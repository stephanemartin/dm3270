# dm3270-lib
This is forked library of [blazemeter](https://github.com/Blazemeter/dm3270). 
That fork was trimmed down version of the [dm3270 emulator](https://github.com/dmolony/dm3270) to be used as TN3270 client library.
...
>Check latest version in [releases](https://github.com/stephanemartin/dm3270/releases).
...
Then, create a [release](https://github.com/stephanemartin/dm3270/releases), this will trigger a Travis build which will publish the jars to the created github release.
